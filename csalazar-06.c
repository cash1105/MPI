...
int main (int argc, char *argv[])
{
    ...
    /* Insertar la funcion de inicializacion del ambiente MPI */
    MPI_Init(&argc, &argv);
    
    /* Insertar la funcion que determina el numero de tareas en el comunicador */
    /* MPI_COMM_WORLD. Guardar el valor en numtasks */
    MPI_Comm_rank(MPI_COMM_WORLD, &taskid);

    /* Insertar la funcion que determina el rango del proceso. Guardar el valor en */
    /* la variable numtasks */
